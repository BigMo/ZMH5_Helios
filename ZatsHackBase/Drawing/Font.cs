...
namespace ZatsHackBase.Drawing
{
    public class Font : IDisposable
    {
        ...
        internal Font(Renderer renderer, string family, float height, bool outlined, bool bold, bool italic, char additionRangeFrom = (char)0, char additionalRangeTo = (char)0)
        {
            ...
            var ranges = new List<Detail.GlyphAtlas.CharRange>(new Detail.GlyphAtlas.CharRange[]{
                    new Detail.GlyphAtlas.CharRange((char)32, (char)1000), //Basic
                    new Detail.GlyphAtlas.CharRange((char)0x0400, (char)0x04ff), //Cyrillic
                    new Detail.GlyphAtlas.CharRange((char)0x0500, (char)0x052f), //Cyrillic Supplementary
                    new Detail.GlyphAtlas.CharRange((char)0x02b0, (char)0x02ff), //Block Elements
                    new Detail.GlyphAtlas.CharRange((char)0x2580, (char)0x259f), //Block Elements
                    new Detail.GlyphAtlas.CharRange((char)0x25A0, (char)0x25ff) //Geometric Shapes
                });
            if (additionRangeFrom != 0 && additionalRangeTo != 0)
                ranges.Add(new Detail.GlyphAtlas.CharRange(additionRangeFrom, additionalRangeTo));
        ...
        private Detail.GlyphAtlas atlas;
